...
def prepare_dataset(images, labels, model, test_size=.2):
    ...
    # Create the datasets
    train_dataset = FreiburgGroceriesDataset(images_train, labels_train)
    test_dataset = FreiburgGroceriesDataset(images_test, labels_test)
